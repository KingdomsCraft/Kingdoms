...
namespace kingdoms\provider\mysql;

use pocketmine\scheduler\AsyncTask;

abstract class MySQLTask extends AsyncTask {

	const KINGDOMS_MYSQLI_KEY = "kingdoms.mysqli";
	...
	public function getMysqli() {
		$mysqli = $this->getFromThreadStore(self::KINGDOMS_MYSQLI_KEY);
		if($mysqli !== null){
			return $mysqli;
		}
		$mysqli = $this->credentials->getMysqli();
		$this->saveToThreadStore(self::KINGDOMS_MYSQLI_KEY, $mysqli);
		return $mysqli;
	}
