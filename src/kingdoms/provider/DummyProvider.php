...
abstract class DummyProvider implements Provider {
	 ...
	 */
	public abstract function create($name, AccountInfo $info);
	...
	/**
	 * Display the top kingdoms to a player
	 *
	 * @param $sender
	 * @param $page
	 *
	 * @return mixed
	 */
	public abstract function top($sender, $page);

	/**
	 * Display a kingdoms info to a player
	 *
	 * @param $sender
	 * @param $kingdom
	 *
	 * @return mixed
	 */
	public abstract function info($sender, $kingdom);
